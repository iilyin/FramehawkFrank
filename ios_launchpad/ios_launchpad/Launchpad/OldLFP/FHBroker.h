...
- (id<FHConnection>) connectToServerEntry:(int)entry withAttributes:(connectionFeatureFlags)attributes andAuth:(id<FHServiceAuth>)auth securely:(BOOL)sec;
- (id<FHConnection>) connectToServerEntry:(int)entry withAttributes:(connectionFeatureFlags)attributes andAuth:(id<FHServiceAuth>)auth securely:(BOOL)sec andHeaders:(NSDictionary*) headers;
- (id<FHConnection>) connectToServerEntry:(int)entry withAttributes:(connectionFeatureFlags)attributes;
